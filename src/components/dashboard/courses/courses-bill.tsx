    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={onNewCourse}
          className="flex items-center gap-1.5 rounded-full bg-primary px-3.5 py-1.5 font-label-md text-label-md text-on-primary hover:opacity-90 transition-opacity"
        >
      ...
      <div className="rounded-3xl border border-outline-variant bg-surface-container-low p-4 md:p-5 flex flex-wrap items-center gap-3">
        ...
        <div className="ms-auto flex flex-wrap gap-2">
          ...
          >
            <AppIcon name="share" className="text-[16px]" />
            {c.billShare}
          </button>
          <button
            type="button"
            ...
            className="flex items-center gap-1.5 rounded-full border border-outline-variant bg-surface px-3.5 py-2 font-label-md text-label-md text-on-surface hover:bg-surface-container-high transition-colors"
          >
            <AppIcon name={copied ? 'check' : 'copy'} className="text-[16px] text-primary" />
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-full border border-outline-variant bg-surface px-3.5 py-2 font-label-md text-label-md text-on-surface hover:bg-surface-container-high transition-colors"
          >
            <AppIcon name="table_rows" className="text-[16px]" />
            {c.billCsv}
          </button>
        </div>
      </div>
