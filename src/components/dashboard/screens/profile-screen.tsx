...
export function ProfileScreen() {
  ...
  return (
    <div className="flex flex-col gap-6 pb-24">
      {/* ── Identity card ── */}
      <div className="rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/5 to-primary/10 p-5 sm:p-6">
        <div className="flex items-start gap-4">
          <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-primary text-2xl font-extrabold text-on-primary shadow-sm">
            {userInitial}
          </div>
            ...
            {isEditingName ? (
              <div className="space-y-2">
                <input
                  ...
                  autoFocus
                  className="w-full rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-sm font-bold text-on-surface outline-none focus:ring-2 focus:ring-primary/30"
                />
                <div className="flex gap-2">
                  <button
                    type="button"
                    onClick={handleSaveName}
                    className="flex-1 rounded-lg bg-primary py-1.5 text-xs font-bold text-on-primary transition-all hover:bg-primary/90"
                  >
                    Save
                  </button>
                  <button
                    ...
                    className="flex-1 rounded-lg bg-surface-variant py-1.5 text-xs font-bold text-on-surface-variant transition-all hover:bg-surface-variant/80"
                  >
                    Cancel
                  </button>
                </div>
              ...
              <>
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="rounded-lg p-1 text-on-surface-variant transition-all hover:bg-primary/10 hover:text-primary"
                  >
                    <AppIcon name="edit" className="text-[15px]" />
                  </button>
                </div>
                <p className="mt-0.5 truncate text-sm text-on-surface-variant">{user?.email}</p>
                <div className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-primary/10 px-2.5 py-1 text-primary">
                  <AppIcon
                    name={isPro ? 'workspace_premium' : 'person'}
                    className="text-[14px]"
                  />
                  <span className="text-xs font-bold">{isPro ? 'Pro Plan' : 'Free Plan'}</span>
                </div>
              </>
            )}
          </div>
