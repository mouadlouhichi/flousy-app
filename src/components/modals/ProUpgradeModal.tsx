  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={isPro ? 'Flousy Pro Membership' : 'Upgrade to Flousy Pro'}>
      <div className="space-y-md">
        {/* Hero Banner */}
        <div className="p-lg rounded-2xl bg-gradient-to-br from-primary via-primary/90 to-tertiary text-on-primary shadow-lg flex flex-col items-center text-center relative overflow-hidden">
          <div className="absolute -right-6 -bottom-6 w-32 h-32 bg-white/10 rounded-full blur-2xl pointer-events-none" />
          <span className="material-symbols-outlined text-[48px] mb-2 font-light">workspace_premium</span>
          <h3 className="font-headline-md text-headline-md font-extrabold tracking-tight">
            {isPro ? 'You are a Pro Member!' : 'Unlock Full Budgeting Power'}
          </h3>
          <p className="font-body-md text-body-md text-on-primary/90 max-w-md mt-1">
            {isPro
        ...
        {!isPro ? (
          <>
            ...
            {/* Feature List */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-sm pt-2">
              <div className="p-md rounded-xl bg-surface-container-low border border-outline-variant flex gap-sm items-start">
