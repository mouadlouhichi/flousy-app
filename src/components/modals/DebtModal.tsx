    ...
    <Modal isOpen={isOpen} onClose={onClose} title={initialDebt ? d.editTitle : addLabel}>
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="flex gap-3 pt-2 border-t border-surface-variant">
          ...
          <button
            type="submit"
            className="flex-1 bg-primary text-on-primary font-bold text-[15px] py-3 rounded-full hover:bg-primary-hover transition-all active:scale-[0.98] shadow-sm flex items-center justify-center gap-2"
          >
