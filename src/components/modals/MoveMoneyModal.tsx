  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={mm.title}>
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <button
          type="submit"
          className="w-full bg-primary text-on-primary font-bold text-[15px] py-3 rounded-full hover:bg-primary-hover transition-all active:scale-[0.98] shadow-sm hover:shadow-md flex items-center justify-center gap-2"
        >
