...
// src/proxy.ts (applied per request, always fail closed). The legacy
...
// self-hosted.
const nextConfig = {
  transpilePackages: ['@flousy/core', '@flousy/email', '@flousy/payments', '@flousy/observability', '@flousy/rate-limit'],
    ...
    return [
      {
        ...
        headers: [
          ...
          // CSP now lives in src/proxy.ts (single source of truth for every
