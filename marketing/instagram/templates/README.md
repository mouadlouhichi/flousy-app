...
- `Inter-Regular.ttf` and `Inter-SemiBold.ttf` for French, English, and Latin supporting copy
...
Install those files in your design tool before editing. If that is not possible, use **Inter** as a Latin fallback and **Noto Sans Arabic** as an Arabic fallback. Keep every Arabic visual line in one Arabic-capable font; never let a design tool silently fall back to a mismatched system font.
...
5. Use **Plus Jakarta Sans ExtraBold** / **Cairo ExtraBold** for display copy. Use **Inter** / **IBM Plex Sans Arabic** for supporting copy, data, and labels.
