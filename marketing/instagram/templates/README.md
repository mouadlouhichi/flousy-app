...
- `InstrumentSans-Bold.ttf` for French, English, and Latin display copy
- `InstrumentSans-Variable.ttf` for French, English, and Latin supporting copy
- `Cairo-ExtraBold.ttf` for Arabic / Darija display copy
- `Cairo-Variable.ttf` for Arabic / Darija supporting copy
...
5. Use the checked-in **Instrument Sans Bold** / **Cairo ExtraBold** instances for display copy, then their variable counterparts for supporting copy.
