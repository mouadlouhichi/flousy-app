...
- [ ] Create the account with the username selected in [`PROFILE_COPY.md`](PROFILE_COPY.md).
- [ ] Convert it to a Professional Business account and enable two-factor authentication.
- [ ] Upload `brand/smartjib-instagram-avatar-1080.png`.
- [ ] Paste the selected bio and add the launch URL with UTM parameters.
...
A sustainable launch rhythm is more valuable than a large one-time content dump:
...
| Spam, harassment or scams | Hide/delete/report according to the account policy; do not amplify it in public replies. |

## Review each week

Track trends, not vanity metrics in isolation:

- **Saves and shares per reach** — strongest signal for helpful educational content.
- **Profile visits → link taps** — shows whether profile positioning is clear.
- **Follows from each post / Reel** — shows which content earns ongoing interest.
- **Story replies, poll votes and question themes** — feeds the next content cycle.
- **Common confusion points** — update Highlights and FAQ copy when the same question repeats.

Do not publish personally identifying follower metrics or individual money stories without direct written permission.
